 ...
 const API_BASE_DEPTO = 'https://censopoblacion.azurewebsites.net/API/indicadores/2/999';
    ...
    function renderDatos(){
        ...
        document.getElementById('porc_pueblo_ladino').textContent = datosGlobalesMuni.porc_pueblo_ladino;
        document.getElementById('pob_pueblo_extranjero').textContent = datosGlobalesMuni.pob_pueblo_extranjero;
        document.getElementById('porc_pueblo_extranjero').textContent = datosGlobalesMuni.porc_pueblo_extranjero;
